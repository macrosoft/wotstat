    ...
    def calcWN8(self, battles):
        ...
        if values['battlesCount'] > 0:
            ...
            for key in ['avgWinRate', 'avgDamage', 'avgFrag', 'avgSpot', 'avgDef', 'avgCap', 'avgHitsRate', \
                ...
                'avgBattleTier', 'medPlace', 'WN6', 'XWN6', 'EFF', 'XEFF', 'vEFF']:
                values[key] = 0
            for key in expKeys:
                values[key] = 1
        ...
        values['XWN8'] = 100 if values['WN8'] > 3400 \
            else int(max(min(values['WN8']*(values['WN8']*(values['WN8']*(values['WN8']*(values['WN8']*\
            (0.00000000000000000009553*values['WN8'] - 0.0000000000000001644) - 0.00000000000426) +\
